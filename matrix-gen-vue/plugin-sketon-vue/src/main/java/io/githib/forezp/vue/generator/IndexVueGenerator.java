...
public class IndexVueGenerator extends SkeletonFileGenerator {
    Logger logger = LoggerFactory.getLogger(SkeletonFileGenerator.class);

    public IndexVueGenerator(SkeletonContext skeletonContext, SkeletonProperties skeletonProperties) {
